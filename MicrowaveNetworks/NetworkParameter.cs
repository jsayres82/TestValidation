...
namespace MicrowaveNetworks
{
    ...
    public readonly struct NetworkParameter : IEquatable<Complex>, IEquatable<NetworkParameter>
    {
        ...
        /// <summary>
        /// Compares two <see cref="NetworkParameter"/> values for Greater than.
        /// </summary>
        ...
        //public static bool operator >(NetworkParameter left, NetworkParameter right) => left.Magnitude_dB > (right.Magnitude_dB);
        ...
        /// <summary>
        /// Compares two <see cref="NetworkParameter"/> values for less than.
        /// </summary>
        /// <param name="left">The left <see cref="NetworkParameter"/>.</param>
        /// <param name="right">The right <see cref="NetworkParameter"/>.</param>
        /// <returns>True if <paramref name="left"/> equals <paramref name="right"/>; otherwise false.</returns>
        ...
        /// <summary>
        /// Compares two <see cref="NetworkParameter"/> values for Greater than or equal to.
        /// </summary>
        /// <param name="left">The left <see cref="NetworkParameter"/>.</param>
        /// <param name="right">The right <see cref="NetworkParameter"/>.</param>
        /// <returns>True if <paramref name="left"/> equals <paramref name="right"/>; otherwise false.</returns>
        ...
        /// <summary>
        /// Compares two <see cref="NetworkParameter"/> values for less than or equal to.
        /// </summary>
        /// <param name="left">The left <see cref="NetworkParameter"/>.</param>
        /// <param name="right">The right <see cref="NetworkParameter"/>.</param>
        /// <returns>True if <paramref name="left"/> equals <paramref name="right"/>; otherwise false.</returns>
