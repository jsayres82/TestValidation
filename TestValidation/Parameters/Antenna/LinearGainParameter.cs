...
namespace Nuvo.TestValidation.Parameters.Antenna
{
    ...
    {
        private Dictionary<string, List<double[]>> linearGainParameterValues = new Dictionary<string, List<double[]>>();
        ...
        public override Dictionary<string, List<object[]>> ParameterValues
        {
            get
            {
                return linearGainParameterValues.ToDictionary(
                    kvp => kvp.Key,
