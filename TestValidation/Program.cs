...
using TestValidation.Requirements.Units;
...
class Program
{
    static void Main()
    {
        ...
        Dictionary<string, double> baseDataSet = new Dictionary<string, double>
        {
            { "Frequency", 10 },
            { "Amplitude", 1 },
            { "Phase", 0 }
        ...
        processor.SetBaseDataSet(baseDataSet);

        // Parse the test requirements from XML
        processor.ParseTestRequirementsFromXml("test_requirement.xml");
