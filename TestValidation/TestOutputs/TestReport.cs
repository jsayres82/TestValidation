    ...
    public class TestReport
    {
        ...
        public void CreatePdfFromXml(string filePath)
        {
            ...
            try
            {
                ...
                pdfDoc = new Document();
                fs = new FileStream($"{filePath}\\SN{SerialNumber}_Result.pdf", FileMode.Create);
                ...
                foreach (XmlNode resultNode in resultNodes)
                {
                    ...
                    double valueAtMinimumMargin = double.Parse(resultNode.SelectSingleNode("ValueAtMinimumMargin")?.InnerText);
                    ...
                    //{
                    //    value = valueAtMinimumMargin.ToString("0.####E+0");
                    //}
